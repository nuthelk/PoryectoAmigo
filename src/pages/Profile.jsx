...
const Profile = () => {
  return (
    <div className="flex flex-col">
      <div className="m-auto mt-10 flex flex-col justify-center items-center gap-2">
        <img
      ...
      <form className="flex flex-col mt-10 gap-5 px-10 mx-auto w-2/3 md:w-3/4 lg:w-1/2 lg:gap-6">
        <h1 className="font-bold text-xl md:text-2xl">Basic Information</h1>
        <input
          className="md:text-lg md:h-12 h-10 border-2 pl-5 md:w-11/12 hover:outline-none"
          placeholder="First Name"
          type="text"
        />
        <input
          className="md:h-12 md:text-lg h-10 border-2 pl-5 md:w-11/12 rounded-md hover:outline-none"
        ...
        <input
          ...
          type="text"
        />
        <div className="w-2/3 mx-auto md:w-1/3 lg:px-10">
          <Button text={"Edit"} />
        </div>
      </form>
    </div>
